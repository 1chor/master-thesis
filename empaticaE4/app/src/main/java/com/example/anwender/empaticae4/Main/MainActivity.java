    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ((isCharging) && (usbCharge || acCharge) && (batteryPct >= 80)) { //focus on accuracy
                ...
                changed = true;
            } else if ((isCharging) && (usbCharge || acCharge) && (batteryPct >= 30) && (batteryPct < 50)) { //focus on accuracy
            ...
            //Discharging
                ...
                ConfigActivity.repo_name = "XFFT";
                changed = true;
            } else if ((isDisCharging) && (!usbCharge) && (!acCharge) && (batteryPct >= 80) && (batteryPct < 90)) { //focus on accuracy
                ConfigActivity.repo_name = "XFFT-fixed";
                changed = true;
